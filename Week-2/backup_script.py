...
if __name__ == "__main__":
    # Example usage
    file_path = 'C:\\Users\\tirthraj bhalodiya\\Desktop\\cc_project\\test_file.txt'  # Change this to the path of your file
    drive_folder_id = '1vSd2K-Bak7whUfIH24uEktz6GcxliTNz'
